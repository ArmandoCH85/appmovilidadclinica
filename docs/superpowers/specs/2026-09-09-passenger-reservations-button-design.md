...
**Fecha**: 2026-09-09
**Estado**: Implementado (commits `d08a79f`, `41a303d`, `cf88b58`). Ícono final: `EventSeat` (asiento literal). Pendiente verificación visual del usuario en el emulador corriendo.
