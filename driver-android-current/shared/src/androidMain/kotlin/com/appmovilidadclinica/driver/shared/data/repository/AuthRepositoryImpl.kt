...
class AuthRepositoryImpl @Inject constructor(
    ...
    /**
     * El plugin Auth de Ktor cachea el Bearer token en memoria y solo llama
     * a loadTokens la primera vez. Si no se limpia, tras un logout + login
     * con otro conductor se siguen mandando los viajes del token anterior.
     */
    private fun clearCachedToken() {
        apiClient.client.authProvider<BearerAuthProvider>()?.clearToken()
    }
