-- =============================================================
-- 0011_allow_paradero_pickup_vuelta.up.sql
-- Permite que los paraderos intermedios de las rutas VUELTA
-- (Pte.Primavera, Angamos, S.B.Norte) permitan pickup (subida
-- de pasajeros), no solo dropoff. Antes solo SEDE permitian
-- pickup en VUELTA. Tambien relaja la validacion del SP
-- sp_search_trips que requeria origin_place.stop_type = 'SEDE'.
-- =============================================================
